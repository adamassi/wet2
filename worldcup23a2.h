...
private:
	...
	//
	int counter;
	RankAvlTree<Team *, CompTeamsByID, EqualTeams> *all_teams;
	RankAvlTree<Team *, CompTeamsByAbility, EqualTeams> *all_teams_ability;
	HashTable<Player*>* players_hash_table;
	UnionFind* uf;
